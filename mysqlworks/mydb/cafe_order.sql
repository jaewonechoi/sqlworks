...
create table cafe_order(
	...
	on delete cascade	-- 부모키의 데이터가 삭제되면 자식 데이터도 자동 삭제
);

-- drink 자료 추가
insert into drink values ('A01', '아메리카노');
insert into drink values ('B01', '카페라떼');
insert into drink values ('C01', '허브티');

-- cafe_order 자료 추가alter
...
-- 주문에 관계없이 주문정보와 음료 정보를 모두 출력하시오
select b.order_no,
	   a.drink_code,
	   a.drink_name,
       b.order_cnt
